...
public abstract class NineGridLayout extends ViewGroup {
    ...
    public void setUrlList(List<String> urlList, String owner, String price) {
    ...
    private void refresh() {
        ...
        if (size == 1) {
            String url = ImageUtils.PICTURE_URL + mOwner + "/" + mUrlList.get(0);
        ...
        for (int i = 0; i < size; i++) {
            String url = ImageUtils.PICTURE_URL + mOwner + "/" + mUrlList.get(i);
    ...
    private RatioImageView createImageView(final int i, final String url) {
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                onClickImage(i, url, mUrlList, mOwner, mPrice);
            }
        });
        return imageView;
    }
    ...
    protected abstract void onClickImage(int position, String url, ArrayList<String> urlList, String mOwner, String price);
}
